...
namespace Tools_XNA.OldTools
{
    public class ParticleSystem
    {
        ...
        // Queue variables
        private int activeStart = 0, nActive = 0;

        // Time particle system was created
        private DateTime start;

        public ParticleSystem(GraphicsDevice graphicsDevice, ContentManager content, Texture2D texture, int nParticles, 
        ...
        // Increases the 'start' parameter by 'count' positions, wrapping around the particle array if necessary
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < end; i++)
            {
                ...
                {
                    // Advance the active particle start position past the particle's index and reduce
                    // the number of active particles by 1
                    activeStart++;
                    nActive--;
